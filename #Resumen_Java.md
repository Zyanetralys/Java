...
- [1. Arquitectura, Ejecución](#1-arquitectura-ejecución)
  - [JDK/JRE/JVM](#1-arquitectura-ejecución)
  - [Bytecode & JIT Compiler](#1-arquitectura-ejecución)
  - [Classloader](#1-arquitectura-ejecución)
  - [Entry Point](#1-arquitectura-ejecución)
  - [Paquetes & Imports](#1-arquitectura-ejecución)
  - [JAR/WAR/EAR/Fat JAR](#1-arquitectura-ejecución)
- [2. Sintaxis, Tipos, Variables](#2-sintaxis-tipos-variables)
  - [Primitivos vs Wrappers](#2-sintaxis-tipos-variables)
  - [String Pool & Inmutabilidad](#2-sintaxis-tipos-variables)
  - [`var` & Inference](#2-sintaxis-tipos-variables)
  - [`final` & Scope](#2-sintaxis-tipos-variables)
- [3. Control de Flujo, Patrones](#3-control-de-flujo-patrones)
  - [Switch Moderno](#3-control-de-flujo-patrones)
  - [Bucles Optimizados](#3-control-de-flujo-patrones)
  - [Break/Continue/Etiquetas](#3-control-de-flujo-patrones)
...
- [4. POO, Modelado de Dominio](#4-poo-modelado-de-dominio)
  ...
  - [Polimorfismo](#4-poo-modelado-de-dominio)
  - [Records (Java 16+)](#4-poo-modelado-de-dominio)
  - [Sealed Classes (Java 17+)](#4-poo-modelado-de-dominio)
  - [`equals/hashCode` Contract](#4-poo-modelado-de-dominio)
- [5. Excepciones, Resiliencia](#5-excepciones-resiliencia)
  - [Checked vs Unchecked](#5-excepciones-resiliencia)
  - [Try-with-Resources](#5-excepciones-resiliencia)
  - [Multi-Catch & Suppressed](#5-excepciones-resiliencia)
- [6. Colecciones, Genéricos](#6-colecciones-genéricos)
  - [List/Set/Map/Queue](#6-colecciones-genéricos)
  - [Generics & Erasure](#6-colecciones-genéricos)
  - [Wildcards PECS](#6-colecciones-genéricos)
  - [Inmutabilidad & Fail-Fast](#6-colecciones-genéricos)
- [7. Streams, Programación Funcional](#7-streams-programación-funcional)
  - [FunctionalInterface & Lambdas](#7-streams-programación-funcional)
  - [Stream API & Pipeline](#7-streams-programación-funcional)
  - [Stateful vs Stateless](#7-streams-programación-funcional)
  - [`Optional` & Collectors](#7-streams-programación-funcional)

### RENDIMIENTO & CONCURRENCIA
- [8. Concurrencia, Paralelismo](#8-concurrencia-paralelismo)
  - [Thread/Runnable/Callable](#8-concurrencia-paralelismo)
  - [ExecutorService](#8-concurrencia-paralelismo)
  - [Synchronized vs Locks](#8-concurrencia-paralelismo)
  - [`volatile` vs Atomic](#8-concurrencia-paralelismo)
  - [`CompletableFuture`](#8-concurrencia-paralelismo)
  - [Virtual Threads (Java 21+)](#8-concurrencia-paralelismo)
  - [Structured Concurrency](#8-concurrencia-paralelismo)
- [9. I/O, NIO, Serialización](#9-io-nio-serialización)
  - [Stream I/O vs NIO.2](#9-io-nio-serialización)
  - [Buffered & Memory-Mapped](#9-io-nio-serialización)
  - [Serialización Java & Riesgos](#9-io-nio-serialización)
- [10. JVM, Memoria](#10-jvm-memoria)
  - [Heap/Stack/Metaspace](#10-jvm-memoria)
  - [GC Algorithms](#10-jvm-memoria)
  - [Memory Leaks & Profiling](#10-jvm-memoria)
  - [JIT Optimizations & Tuning Flags](#10-jvm-memoria)

### METAPROGRAMACIÓN & HERRAMIENTAS
- [11. Anotaciones](#11-anotaciones)
  - [Reflection](#11-anotaciones)
  - [Anotaciones & Retention/Target](#11-anotaciones)
  - [Processors (APT)](#11-anotaciones)
- [12. Frameworks](#12-frameworks)
  - [Maven/Gradle](#12-frameworks)
  - [JPMS (Java 9+)](#12-frameworks)
  - [Spring Core/DI/Boot](#12-frameworks)
  - [AOP & Proxies](#12-frameworks)
  - [JPA/Hibernate](#12-frameworks)
  - [HikariCP](#12-frameworks)
- [13. Web, APIs](#13-web-apis)
  - [HTTP Client (Java 11+)](#13-web-apis)
  - [REST Controllers](#13-web-apis)
  - [gRPC & Protobuf](#13-web-apis)
  - [JSON Serialization](#13-web-apis)
  - [AuthN/Z](#13-web-apis)
- [14. Testing](#14-testing)
  - [JUnit 5 & Assertions](#14-testing)
  - [Mocking (Mockito)](#14-testing)
  - [Testcontainers](#14-testing)
  - [Coverage & Property-Based](#14-testing)

### PRODUCCIÓN & SEGURIDAD
- [15. CI/CD](#15-cicd)
  - [Build Pipeline](#15-cicd)
  - [Docker & JVM](#15-cicd)
  - [K8s Probes](#15-cicd)
  - [Observability & Logging](#15-cicd)
- [16. Seguridad](#16-seguridad)
  - [OWASP Java Top 10](#16-seguridad)
  - [SQLi/XXE](#16-seguridad)
  - [Crypto & Secrets](#16-seguridad)
  - [AuthN/Z Best Practices](#16-seguridad)
  - [Dependency Scanning](#16-seguridad)
- [17. Java Moderno (21-2026)](#17-java-moderno-21-2026)
  - [Pattern Matching Everywhere](#17-java-moderno-21-2026)
  - [Scoped Values](#17-java-moderno-21-2026)
  - [Foreign Function & Memory API](#17-java-moderno-21-2026)
  - [String Templates](#17-java-moderno-21-2026)
  - [Generational ZGC](#17-java-moderno-21-2026)
  - [JEP Lifecycle](#17-java-moderno-21-2026)

### OPERACIONES & COMUNICACIÓN
- [18. Comunicación](#18-comunicación)
  - [Trade-off Framework](#18-comunicación)
  - [Preguntas Trampa Comunes](#18-comunicación)
  - [System Design Básico](#18-comunicación)
  - [Debugging Workflow](#18-comunicación)
  - [Behavioral (STAR)](#18-comunicación)
  - [Code Review Focus](#18-comunicación)
- [19. Checklist](#19-checklist)
  - [Preparación Técnica](#19-checklist)
  - [Despliegue](#19-checklist)
